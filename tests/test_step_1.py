...
@pytest.mark.asyncio
async def test_unified_message_handler_telegram_echo() -> None:
    ...
    await caspian_agent.unified_message_handler(mock_msg)
...
@pytest.mark.asyncio
async def test_unified_message_handler_email_echo() -> None:
